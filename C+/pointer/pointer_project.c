...
//물이 다 증발하기 전에 부지런히 어항에 물을 줘서 물고기를 살려 주세요
//물고기는 시간이 지날수록 점점 켜져서 나중에는 냠냠
int level;
int arrayFish[6];
int * cursor;
...
int main_pointer_project(void)
{
	...
	while (1) //1? 무한반복
	{
		...
		//사용자가 입력한 어항에 물을 준다.
		// 1. 어항의 물이 0이면? 물을 주지 않는다... 이미 고기가 죽었기에
		if (cursor[num - 1] <= 0)
		{
